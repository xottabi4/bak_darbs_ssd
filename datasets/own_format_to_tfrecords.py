...
DIRECTORY_ANNOTATIONS = 'input_images_roi/'
DIRECTORY_IMAGES = 'input_images/'
...
def run(dataset_dir, output_dir, name='own_dataset_train', shuffling=True):
    ...
    txtname = os.path.join(dataset_dir, 'train.txt')
    ...
    print('\nFinished converting the own dataset!')
